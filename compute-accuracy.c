...
int main(int argc, char **argv)
{
  ...
  real dist, len, bestd[N], vec[max_size];
  ...
  for (b = 0; b < words; b++) {
    ...
    for (a = 0; a < size; a++) fread(&M[a + b * size], sizeof(real), 1, f);
    len = 0;
